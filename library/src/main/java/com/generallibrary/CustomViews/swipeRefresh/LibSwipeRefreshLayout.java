 ...
 * </p>
 */
public class LibSwipeRefreshLayout extends ViewGroup implements NestedScrollingParent,
    ...
    private static final String LOG_TAG = LibSwipeRefreshLayout.class.getSimpleName();
     ...
     * @param context
     */
    public LibSwipeRefreshLayout(Context context) {
        this(context, null);
    }
     ...
     * @param attrs
     */
    public LibSwipeRefreshLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
