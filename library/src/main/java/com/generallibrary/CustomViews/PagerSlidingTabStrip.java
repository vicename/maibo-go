...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    private int tabBackgroundResId = R.drawable.picture;
...
//        defaultTabLayoutParams = new LinearLayout.LayoutParams(LayoutParams.WRAP_CONTENT, getHeight());
...
//            v.setBackgroundResource(tabBackgroundResId);
     ...
     * @param v
     */
    private void moveToMiddle(View v) {
        int left = v.getLeft();
        int right = v.getRight();
        int screenWidth = LibCommonUtils.getScreenWidth(getContext());
        smoothScrollTo(left - (screenWidth / 2 - (right - left) / 2), 0);
    }
...
//        }
    ...
    private class PageListener implements OnPageChangeListener {
        ...
        public void onPageSelected(int position) {
            ...
            updateTabStyles();
            moveToMiddle(tabsContainer.getChildAt(position));
            if (delegatePageListener != null) {
