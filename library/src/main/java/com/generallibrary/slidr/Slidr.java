package com.generallibrary.slidr;
...
import com.generallibrary.slidr.model.SlidrInterface;
import com.generallibrary.slidr.widget.SliderPanel;
...
public class Slidr {
     ...
     * @return              a {@link com.generallibrary.slidr.model.SlidrInterface} that allows
    ...
    /**
     * Attach a slider mechanism to an activity based on the passed {@link com.generallibrary.slidr.model.SlidrConfig}
     *
     * @param activity      the activity to attach the slider to
